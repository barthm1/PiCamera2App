...
class FinerControl ( BasicNotepage ):
	def BuildPage ( self ):
		...
		self.Timestamp =MyStringVar(int(metadata.get("SensorTimestamp")))
		...
		self.StillStats = MyBooleanVar(False)
		MyRadio(f,'Off (default)', False,b,self.StillStatsChanged,0,0,'NW',tip=363)
	...
	def UpdateTimestamp ( self ):
		...
		self.Timestamp.set(int(metadata.get("SensorTimestamp")))
